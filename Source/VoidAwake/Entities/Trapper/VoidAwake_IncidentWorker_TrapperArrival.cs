...
namespace VoidAwake
{
	public class VoidAwake_IncidentWorker_TrapperArrival : IncidentWorker
	{
		...
		protected override bool TryExecuteWorker(IncidentParms parms)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				Pawn trapper = PawnGenerator.GeneratePawn(VoidAwake_TrapperDefOf.VoidAwake_Trapper, Faction.OfEntities);
				GenSpawn.Spawn(trapper, cell, map);
				VoidAwake_TrapperLoadoutUtility.EnsureRabbitShotEquipped(trapper);
