...
namespace VoidAwake
{
	public class VoidAwake_GameComponent_TrapperKidnaps : GameComponent
	{
		private List<VoidAwake_TrapperKidnapRecord> kidnapped = new List<VoidAwake_TrapperKidnapRecord>();

		public VoidAwake_GameComponent_TrapperKidnaps(Game game)
		{
		}

		public static VoidAwake_GameComponent_TrapperKidnaps Get()
		{
			return Current.Game?.GetComponent<VoidAwake_GameComponent_TrapperKidnaps>();
		}
