...
namespace VoidAwake
{
	public class VoidAwake_JobGiver_TrapperCreateRabbitPassage : ThinkNode_JobGiver
	{
		protected override Job TryGiveJob(Pawn pawn)
		{
			...
			if (!VoidAwake_RabbitPassageUtility.TryFindPassagePair(pawn, out IntVec3 entrance, out IntVec3 exit))
			{
