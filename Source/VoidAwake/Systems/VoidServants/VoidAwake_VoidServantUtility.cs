...
namespace VoidAwake
{
	public class VoidAwake_ModExtension_VoidServant : DefModExtension
	{
	}

	public static class VoidAwake_VoidServantUtility
	{
		public static bool IsVoidServant(ThingDef def)
		{
			return def?.GetModExtension<VoidAwake_ModExtension_VoidServant>() != null;
		}
