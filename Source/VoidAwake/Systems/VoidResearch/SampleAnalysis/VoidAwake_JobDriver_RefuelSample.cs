...
namespace VoidAwake
{
    public abstract class VoidAwake_JobDriver_RefuelSampleBase<TComp> : JobDriver
    ...
    public class VoidAwake_JobDriver_RefuelBasicSample
        : VoidAwake_JobDriver_RefuelSampleBase<VoidAwake_CompRefuelable_BasicSample>
    { }

    public class VoidAwake_JobDriver_RefuelAdvancedSample
        : VoidAwake_JobDriver_RefuelSampleBase<VoidAwake_CompRefuelable_AdvancedSample>
    { }
}
