...
namespace VoidAwake
{
        ...
        public static IEnumerable<Gizmo> GetGizmosFor(Pawn target)
        {
            ...
            yield return new Command_Action
            {
                ...
                action = () =>
                {
                    ...
                    Find.WindowStack.Add(new VoidAwake_Dialog_GeneExtraction(target, genes));
                }
            };
        }
    }
    ...
    public static class VoidAwake_Patch_Pawn_GetGizmos_GeneExtraction
    {
    ...
    public static class VoidAwake_Patch_HoldingPlatform_GetGizmos_GeneExtraction
    {
    ...
    public static class VoidAwake_Patch_HoldingPlatform_GetFloatMenuOptions_GeneExtraction
    {
