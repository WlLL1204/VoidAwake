...
namespace VoidAwake
{
    public class VoidAwake_WorldDrawLayer_VoidTile : WorldDrawLayer
    {
        ...
        private void AddTileMesh(PlanetTile tile, VoidAwake_WorldComponent_VoidErosion erosion)
        {
            VoidAwake_VoidErosionLevel level = erosion.GetErosionLevel(tile);
            if (level == VoidAwake_VoidErosionLevel.None)
                return;
        ...
        //渦マテリアルの浸食レベルによる切り替え
        private static Material SwirlMatFor(VoidAwake_VoidErosionLevel level)
        {
            EnsureSwirlMats();
            switch (level)
            {
                case VoidAwake_VoidErosionLevel.Extreme: return swirlExtreme;
                case VoidAwake_VoidErosionLevel.Heavy: return swirlHeavy;
                case VoidAwake_VoidErosionLevel.Medium: return swirlMedium;
                default: return swirlLight;
            }
        }

        private void AddSwirlMesh(PlanetTile tile, VoidAwake_WorldComponent_VoidErosion erosion, VoidAwake_VoidErosionLevel level)
        {
        ...
        //タイル毎の浸食率の描画
        private static Color32 ColorFor(VoidAwake_VoidErosionLevel level)
        {
            switch (level)
            {
                case VoidAwake_VoidErosionLevel.Extreme: return new Color32(0, 0, 0, 220);       // 黒
                case VoidAwake_VoidErosionLevel.Heavy: return new Color32(60, 10, 90, 180);    // 濃い紫
                case VoidAwake_VoidErosionLevel.Medium: return new Color32(120, 30, 170, 140);  // 紫
                case VoidAwake_VoidErosionLevel.Light: return new Color32(160, 80, 200, 90);   // 薄い紫
