...
namespace VoidAwake
{
    ...
    /// </summary>
    public class VoidAwake_VoidMagicTier
    {
        [MustTranslate]
        public string label;
    ...
    public class VoidAwake_VoidMagicDef : Def
    {
        ...
        public List<VoidAwake_VoidMagicTier> tiers = new List<VoidAwake_VoidMagicTier>();
        ...
        public VoidAwake_VoidMagicTier TierAt(int index)
        {
