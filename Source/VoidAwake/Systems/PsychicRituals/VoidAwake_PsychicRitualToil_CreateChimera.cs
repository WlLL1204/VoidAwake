...
namespace VoidAwake
{
	public class VoidAwake_PsychicRitualToil_CreateChimera : PsychicRitualToil
	{
		private PsychicRitualRoleDef invokerRole;
		private PawnKindDef chimeraPawnKind;

		protected VoidAwake_PsychicRitualToil_CreateChimera()
		{
		}

		public VoidAwake_PsychicRitualToil_CreateChimera(PsychicRitualRoleDef invokerRole, PawnKindDef chimeraPawnKind)
		{
		...
		private void ApplyOutcome(PsychicRitual psychicRitual, Pawn invoker)
		{
			...
			VoidAwake_VoidServantUtility.EnsureTamenessComplete(chimera);
