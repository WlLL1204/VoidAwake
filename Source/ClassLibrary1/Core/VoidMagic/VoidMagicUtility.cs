...
namespace VoidAwake
{
    public static class VoidMagicUtility
    {
        ...
        public static VoidAwake_VoidMagicComp GetComp(Pawn pawn)
        {
            return pawn?.TryGetComp<VoidAwake_VoidMagicComp>();
        }
        ...
        public static CompVoidAwake_MeditationAnchor AnchorUnder(Pawn pawn)
        {
            Map map = pawn?.Map;
            if (map == null)
            {
            ...
            {
                CompVoidAwake_MeditationAnchor anchor =
                    things[i].TryGetComp<CompVoidAwake_MeditationAnchor>();
                if (anchor != null)
                {
                    return anchor;
                }
