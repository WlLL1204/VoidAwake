...
namespace VoidAwake
{
    public class ITab_Pawn_VoidMagic : ITab
    {
        ...
        public override bool IsVisible
        {
            get
            {
                ...
                return VoidMagicUtility.Active
                    && pawn != null
                    && pawn.IsColonistPlayerControlled
                    && VoidMagicUtility.GetComp(pawn) != null;
            }
        }
        ...
        {
            Pawn pawn = PawnToShow;
            VoidAwake_VoidMagicComp comp = VoidMagicUtility.GetComp(pawn);
            if (comp == null)
            {
                return;
            }
        ...
        private static void BuildRows(VoidAwake_VoidMagicComp comp)
        {
            tmpRows.Clear();
            ...
            foreach (ThingDef entityDef in VoidMagicUtility.ContainedEntityDefsNow())
            {
        ...
        private void DrawRow(Rect rect, VoidAwake_VoidMagicComp comp, ThingDef entityDef, int index)
        {
            ...
            Widgets.Label(labelRect, VoidMagicUtility.EntityLabel(entityDef));
        ...
        private static void DrawStatus(Rect rect, VoidAwake_VoidMagicComp comp, VoidAwake_VoidLink link,
            VoidAwake_VoidMagicDef magicDef, int tierIndex)
        {
            VoidMagicTier tier = magicDef.TierAt(tierIndex);
