...
namespace VoidAwake
{
	public class JobDriver_CreateRabbitPassage : JobDriver
	{
		...
		protected override IEnumerable<Toil> MakeNewToils()
		{
			...
			this.FailOn(() => !RabbitPassageUtility.IsValidPassageCell(Map, job.GetTarget(EntranceInd).Cell)
				|| !RabbitPassageUtility.IsValidPassageCell(Map, job.GetTarget(ExitInd).Cell));
